        ...
        <Sider
          ...
          {this.state.theme === 'light'
            ? <a
                ...
                target='_blank'
                rel='noopener noreferrer'><Icon type="github" className="github"/></a>
            : <a
              href="https://github.com/MuYunyun/react-antd-demo"
              target='_blank'
              rel='noopener noreferrer'><Icon type="github" className="github white"/></a>}
          {this.state.theme === 'light'
            ? <span className="author">mockx</span>
            : <span className="author white">mockx</span>}
          <Menu
